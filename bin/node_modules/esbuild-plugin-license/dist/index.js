...
var require_lib2 = __commonJS({
  "node_modules/.pnpm/@babel+highlight@7.16.7/node_modules/@babel/highlight/lib/index.js"(exports2) {
    "use strict";
    init_cjs_shims();
    Object.defineProperty(exports2, "__esModule", {
      value: true
...
var require_git_host_info = __commonJS({
  "node_modules/.pnpm/hosted-git-info@4.1.0/node_modules/hosted-git-info/git-host-info.js"(exports2, module2) {
    "use strict";
    init_cjs_shims();
    ...
    var defaults = {
      ...
      browsefiletemplate: ({ domain, user, project, committish, treepath, path: path6, fragment, hashformat }) => `https://${domain}/${user}/${project}/${treepath}/${maybeEncode(committish || "master")}/${path6}${maybeJoin("#", hashformat(fragment || ""))}`,
      docstemplate: ({ domain, user, project, treepath, committish }) => `https://${domain}/${user}/${project}${maybeJoin("/", treepath, "/", maybeEncode(committish))}#readme`,
      httpstemplate: ({ auth, domain, user, project, committish }) => `git+https://${maybeJoin(auth, "@")}${domain}/${user}/${project}.git${maybeJoin("#", committish)}`,
      filetemplate: ({ domain, user, project, committish, path: path6 }) => `https://${domain}/${user}/${project}/raw/${maybeEncode(committish) || "master"}/${path6}`,
    ...
    gitHosts.github = Object.assign({}, defaults, {
      ...
      domain: "github.com",
      treepath: "tree",
      filetemplate: ({ auth, user, project, committish, path: path6 }) => `https://${maybeJoin(auth, "@")}raw.githubusercontent.com/${user}/${project}/${maybeEncode(committish) || "master"}/${path6}`,
    ...
    gitHosts.gist = Object.assign({}, defaults, {
      ...
      browsefiletemplate: ({ domain, project, committish, path: path6, hashformat }) => `https://${domain}/${project}${maybeJoin("/", maybeEncode(committish))}${maybeJoin("#", hashformat(path6))}`,
    ...
    gitHosts.sourcehut = Object.assign({}, defaults, {
      ...
      domain: "git.sr.ht",
      treepath: "tree",
      browsefiletemplate: ({ domain, user, project, committish, treepath, path: path6, fragment, hashformat }) => `https://${domain}/${user}/${project}/${treepath}/${maybeEncode(committish || "main")}/${path6}${maybeJoin("#", hashformat(fragment || ""))}`,
      filetemplate: ({ domain, user, project, committish, path: path6 }) => `https://${domain}/${user}/${project}/blob/${maybeEncode(committish) || "main"}/${path6}`,
...
var require_git_host = __commonJS({
  "node_modules/.pnpm/hosted-git-info@4.1.0/node_modules/hosted-git-info/git-host.js"(exports2, module2) {
    "use strict";
    init_cjs_shims();
    ...
    var GitHost = class {
      ...
      _fill(template2, opts) {
        if (typeof template2 === "function") {
          ...
          const result = template2(options);
      ...
      browse(path6, fragment, opts) {
        if (typeof path6 !== "string") {
          return this._fill(this.browsetemplate, path6);
        }
        if (typeof fragment !== "string") {
          opts = fragment;
          fragment = null;
        }
        return this._fill(this.browsefiletemplate, __spreadProps(__spreadValues({}, opts), { fragment, path: path6 }));
      }
      docs(opts) {
      ...
      file(path6, opts) {
        return this._fill(this.filetemplate, __spreadProps(__spreadValues({}, opts), { path: path6 }));
      }
...
var require_hosted_git_info = __commonJS({
  "node_modules/.pnpm/hosted-git-info@4.1.0/node_modules/hosted-git-info/index.js"(exports2, module2) {
    "use strict";
    init_cjs_shims();
    var url = require("url");
    var gitHosts = require_git_host_info();
...
var require_core = __commonJS({
  "node_modules/.pnpm/is-core-module@2.8.1/node_modules/is-core-module/core.json"(exports2, module2) {
    module2.exports = {
      assert: true,
...
var require_is_core_module = __commonJS({
  "node_modules/.pnpm/is-core-module@2.8.1/node_modules/is-core-module/index.js"(exports2, module2) {
    "use strict";
    init_cjs_shims();
    var has = require_src();
...
var require_extract_description = __commonJS({
  "node_modules/.pnpm/normalize-package-data@3.0.3/node_modules/normalize-package-data/lib/extract_description.js"(exports2, module2) {
    init_cjs_shims();
...
var require_typos = __commonJS({
  "node_modules/.pnpm/normalize-package-data@3.0.3/node_modules/normalize-package-data/lib/typos.json"(exports2, module2) {
    module2.exports = {
      topLevel: {
...
var require_fixer = __commonJS({
  "node_modules/.pnpm/normalize-package-data@3.0.3/node_modules/normalize-package-data/lib/fixer.js"(exports2, module2) {
    init_cjs_shims();
...
var require_warning_messages = __commonJS({
  "node_modules/.pnpm/normalize-package-data@3.0.3/node_modules/normalize-package-data/lib/warning_messages.json"(exports2, module2) {
    module2.exports = {
...
var require_make_warning = __commonJS({
  "node_modules/.pnpm/normalize-package-data@3.0.3/node_modules/normalize-package-data/lib/make_warning.js"(exports2, module2) {
    init_cjs_shims();
    var util = require("util");
...
var require_normalize = __commonJS({
  "node_modules/.pnpm/normalize-package-data@3.0.3/node_modules/normalize-package-data/lib/normalize.js"(exports2, module2) {
    init_cjs_shims();
...
var import_parse_json = __toESM(require_parse_json(), 1);
var import_normalize_package_data = __toESM(require_normalize(), 1);
async function readPackage({ cwd = import_node_process2.default.cwd(), normalize = true } = {}) {
  const filePath = import_node_path3.default.resolve(cwd, "package.json");
  const json = (0, import_parse_json.default)(await import_node_fs3.promises.readFile(filePath, "utf8"));
  if (normalize) {
...
async function readPackageUp(options) {
  ...
  return {
    packageJson: await readPackage(__spreadProps(__spreadValues({}, options), { cwd: import_node_path4.default.dirname(filePath) })),
    path: filePath
  };
}
...
function esbuildPluginLicense(options = {}) {
  ...
  const getLicenseText = async (pkgJsonPath) => {
    const dir = import_path.default.dirname(pkgJsonPath);
    ...
    if (idx !== -1) {
      return import_fs.default.readFileSync(import_path.default.join(dir, files[idx])).toString();
    }
    return "";
  };
  return {
    ...
    async setup(build) {
      ...
      let userBanner = (_a = build.initialOptions.banner) == null ? void 0 : _a.js;
      userBanner = userBanner ? userBanner + "\n" : "";
      build.initialOptions.banner = __spreadProps(__spreadValues({}, build.initialOptions.banner), {
        js: userBanner + template_default(banner)({ pkg: pkg == null ? void 0 : pkg.packageJson })
      });
      build.onLoad({ filter: /.*/ }, async (args) => {
        var _a2;
        const result = await readPackageUp({
          cwd: import_path.default.dirname(args.path)
        });
        if (result) {
      ...
      build.onEnd(async () => {
        ...
        const outdir = (_g = build.initialOptions.outdir) != null ? _g : ".";
        if (!import_path.default.isAbsolute(outputFile))
          outputFile = import_path.default.join(outdir, outputFile);

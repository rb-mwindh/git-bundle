...
declare type Package = normalize.Package;
declare type NormalizedPackageJson = Package & PackageJson;
...
declare const defaultOptions: DeepRequired<Options>;
declare function esbuildPluginLicense(options?: Options): Plugin;

export { Dependency, Options, esbuildPluginLicense as default, defaultOptions };
